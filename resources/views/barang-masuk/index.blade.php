...
@section('content')
    <div class="section-header d-flex justify-content-between align-items-center">
        <h1 class="h3 mb-0 font-weight-bold">Data Barang Masuk</h1>
        <a href="{{ route('barang-masuk.create') }}" class="btn btn-primary btn-sm px-3">
        ...
        <div class="card-body">
            ...
            @if($barangMasuk && $barangMasuk->count() > 0)
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <div>
                        Showing {{ $barangMasuk->firstItem() }} to {{ $barangMasuk->lastItem() }} of {{ $barangMasuk->total() }} entries
                    </div>
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <p class="text-dark mb-0" style="font-size: 0.875rem">Belum ada data barang Masuk</p>
                </div>
            @endif
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchData(page = 1) {
                ...
                fetch(`/barang-masuk?page=${page}&search=${searchTerm}&perPage=${perPage}`, {
                    headers: {
                    ...
                    button.addEventListener('click', function() {
                        ...
                        fetch(`/barang-masuk/${id}/detail`)
                            ...
                            .then(data => {
                                ...
                                document.getElementById('modal-tanggal').textContent = data.tanggal_masuk;
