        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                <tr class="barang-row" id="index_${value.id}">
                    ...
                    <td>
                        <div class="d-flex">
                            <a href="javascript:void(0)" id="button_edit_nama_departemen" data-id="${value.id}" class="btn btn-icon btn-warning btn-lg mr-2"><i class="far fa-edit"></i></a>
                            <a href="javascript:void(0)" id="button_hapus_nama_departemen" data-id="${value.id}" class="btn btn-icon btn-danger btn-lg"><i class="fas fa-trash"></i></a>
                        </div>
                    </td>
                </tr>
            `;
